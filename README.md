...
## Адрес: 46.174.48.78:25565
## Пароль: 2406 (при входе на сервер нужно написать /login 2406)



![server](https://user-images.githubusercontent.com/95046139/179245002-08e05490-23a1-4fb5-9adb-f79bb5636650.png)


## Basics


Ванильный MC 1.19. Играть можно (и нужно) с пиратской версии. Установлены всего два плагина: приват территорий и варпы. Видео/текстовые подсказки по использованию ниже :)


**Единственное правило:** пожалуйста, не используйте читы/баги/дюпы/etc. Мы чиллим в майне, а не потеем в ксго...

Все остальное - можно. Спамить в чат "nigger faggot" - тоже.
...
Все команды, использующие никнеймы игроков, работают, только если этот игрок онлайн! Например, вы не можете выписать из региона игрока, который в данный момент не на сервере.
...
Не ставьте регионы вплотную к краям или стенам своих построек, делайте их на несколько блоков шире, чтобы никто не подсунул вам динамит или не залил все вокруг лавой :)
